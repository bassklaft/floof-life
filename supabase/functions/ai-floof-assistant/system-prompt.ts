// Mirror of src/data/floofAssistantSystem.js. If you edit the system
// prompt, update BOTH files — they need to match so the client and
// the server agree on the persona / safety contract.
//
// Keep this file STATIC. No date, no per-request data, nothing
// volatile — anything that varies invalidates the Anthropic
// prompt-cache prefix and we pay full input price on every call.
